...
const etymology = [
  ...
  },
  {
    ...
    meaning: 'Sapphire',
<<<<<<< HEAD
    description: 'Clarity, value, and rarity. The sapphire represents precision thinking and the quality of every transaction structured under the ZAFRIQON name.',
=======
